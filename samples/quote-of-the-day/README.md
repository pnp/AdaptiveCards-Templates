...
Simple card designed to show a 'quote of the day'. 

The Data JSON option has been leveraged to enable users without advanced knowledge of JSON to easily update the quote.
...
- **Description** - *View the quote of the day.*
- **Card action** - Show the quick view
- **Primary Button** - Off
- **Secondary Button** - Off
- **Template JSON** - Paste in the content of the *ac-qv-quote-of-the-day.json* file
- **Data JSON** - Paste in the content of the *ac-qv-quote-of-the-day.data.json* file
...
<img src="https://pnptelemetry.azurewebsites.net/adaptivecards-templates/samples/quote-of-the-day" />