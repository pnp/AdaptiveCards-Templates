...
Solution|Author(s)
--------|---------
timeoff | Max Kulakov, Microsoft & [Vesa Juvonen](https://github.com/vesajuvonen) ([@vesajuvonen](https://twitter.com/vesajuvonen)), Microsoft
...
- **Heading** - *11 days*
- **Description** - *Currently available paid time off*
...
- **Template JSON** - Paste in the content of the *ac-qv-time-off.json* file
...
<img src="https://pnptelemetry.azurewebsites.net/adaptivecards-templates/samples/timeoff" />