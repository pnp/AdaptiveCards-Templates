...
<p>
    <a href="https://adaptivecards.io/designer/index.html?card=https%3A%2F%2Fraw.githubusercontent.com%2Fpnp%2FAdaptiveCards-Templates%2Fmain%2Fsamples%2Ftimeline-holidays%2Fac-qv-holidays.json">
...
Solution|Author(s)
--------|---------
timeline-holidays | Max Kulakov, Microsoft & [Vesa Juvonen](https://github.com/vesajuvonen) ([@vesajuvonen](https://twitter.com/vesajuvonen)), Microsoft
...
- **Heading** - *Thanksgiving November 25th*
- **Image** - Custom image - upload *autumn.jpg* from the assets folder as the image
- **Action** - Show the quick view
- **Template JSON** - Paste in the content of the *ac-qv-holidays.json* file
