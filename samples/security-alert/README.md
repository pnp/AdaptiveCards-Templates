...
- **Template JSON** - Paste in the content of the *ac-qv-security-alert-json* file
- **Data JSON** - Paste in the content of the *ac-qv-security-alert.data.json* file
...
<img src="https://pnptelemetry.azurewebsites.net/adaptivecards-templates/samples/security-alert" />