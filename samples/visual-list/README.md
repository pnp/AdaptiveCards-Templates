...
- **Heading** - *Cafeteria 34*
- **Description** - *Open • Closes in 30 min*
- **Card action** - go to a link
- **Link** - https://news.microsoft.com/life/microsoft-cafes-dish-up-world-class-dining-choices/
- **Primary Button** - Off
- **Secondary Button** - On
- **Title** - *Report*
- **Action** - Show the quick view
- **Template JSON** - Paste in the content of the *ac-qv-cafe.json* file
