...
<p>
    <a href="https://adaptivecards.io/designer/index.html?card=https%3A%2F%2Fraw.githubusercontent.com%2Fpnp%2FAdaptiveCards-Templates%2Fmain%2Fsamples%2Fimage-carousel%2Fac-qv-product.json">
...
Solution|Author(s)
--------|---------
image-carousel | Max Kulakov, Microsoft & [Vesa Juvonen](https://github.com/vesajuvonen) ([@vesajuvonen](https://twitter.com/vesajuvonen)), Microsoft
...
- **Card size** - Medium
- **Title** - *Devices*
- **Icon** - Custom image - Upload *img-hololens-2.jpg* from the assets folder
- **Heading** - *HoloLens 2*
- **Description** - *For precise, efficient hands-free work*
- **Card action** - Show the quick view
- **Primary Button** - Off
- **Secondary Button** - Off
- **Template JSON** - Paste in the content of the *ac-qv-product.json* file
...
<img src="https://pnptelemetry.azurewebsites.net/adaptivecards-templates/samples/image-carousel" />